...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        exploreMembersTab.tabBarItem = UITabBarItem(title: "팀원탐색", image: UIImage(named: "tabBarItem.timetable") ?? UIImage(), selectedImage: UIImage(named: "tabBarItem.timetable.fill") ?? UIImage())
        ...
        // MARK: - homeTab
        homeTab.tabBarItem = UITabBarItem(title: "홈", image: UIImage(named: "tabBarItem.home") ?? UIImage(), selectedImage: UIImage(named: "tabBarItem.home.fill") ?? UIImage())
        ...
        // MARK: - myPageTab
        myPageTab.tabBarItem = UITabBarItem(title: "마이페이지", image: UIImage(named: "tabBarItem.myPage") ?? UIImage(), selectedImage: UIImage(named: "tabBarItem.myPage.fill") ?? UIImage())
